...
echo "   - Recommended first step: bash scripts/train_server_stage_a.sh"
...
echo "🔍 Validate with: bash scripts/test_server_single.sh val"
echo "☁️  Export PLY with: bash scripts/export_server_single.sh"
echo ""
